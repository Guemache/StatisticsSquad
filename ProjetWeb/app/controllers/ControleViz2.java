...
public class ControleViz2 extends Controller {
	//fichier de rdf pour les requêtes
	...
	public static Result viz2(){
		...
		//Construction d'une requête dynamque
